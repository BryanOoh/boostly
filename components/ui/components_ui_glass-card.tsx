...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      ...
      "bg-[rgba(217,223,232,0.78)] border-[rgba(209,213,219,0.3)]",
      "dark:backdrop-filter dark:backdrop-blur-[22px] dark:backdrop-saturate-[180%]",
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn("text-sm text-gray-600 dark:text-white/70", className)}
    {...props}
  />
))
